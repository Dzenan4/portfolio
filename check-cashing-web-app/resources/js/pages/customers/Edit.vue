...
import { type CustomerForm, type Customer } from '@/types';
...
const {currentCustomer} = defineProps<{
...
const form = useForm<CustomerForm>({
    ...
    middle_initial: currentCustomer.middle_initial,
    last_name: currentCustomer.last_name,
    address_street: currentCustomer.address_street,
    address_city: currentCustomer.address_city,
    address_state: currentCustomer.address_state,
    address_zip: currentCustomer.address_zip,
    phone_number: currentCustomer.phone_number,
    dl_number: currentCustomer.dl_number,
    dl_state: currentCustomer.dl_state,
    dob: currentCustomer.dob,
    dl_picture_link: null,
    self_picture_link: null,
...
// Submit form action
const submit = () => {
    form.post(route('customers.update', currentCustomer.id));
};
                                    ...
                                    <div class="grid gap-2 w-1/2">
                                        ...
                                        <div class="flex gap-6">
                                            ...
                                            <div class="grid gap-2 w-full">
                                                ...
                                                />
                                                <div 
                                                    class="flex h-24 space-x-2"
                                                    v-if="currentCustomer.dl_picture_link || driversLicensePicturePreview || form.errors.dl_picture_link || currentCustomer.self_picture_link || selfPicturePreview || form.errors.self_picture_link">
                                                    <img v-if="currentCustomer.dl_picture_link" :src="currentCustomer.dl_picture_link.toString()" alt="" :class="[driversLicensePicturePreview ? 'opacity-30' : '', 'h-24 w-18']" />
                                    ...
                                    <div class="grid gap-2 w-1/2">
                                        ...
                                        <div class="flex gap-6">
                                            <div class="grid gap-2 w-full">
                                                ...
                                                <div 
                                                    class="flex h-24 space-x-2"
                                                    v-if="currentCustomer.self_picture_link || selfPicturePreview || form.errors.self_picture_link || currentCustomer.dl_picture_link || driversLicensePicturePreview || form.errors.dl_picture_link">
                                                    <img v-if="currentCustomer.self_picture_link" :src="currentCustomer.self_picture_link.toString()" alt="" :class="[selfPicturePreview ? 'opacity-30' : '', 'h-24 w-18']"/>
