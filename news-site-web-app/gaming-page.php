...
<body class="body-container">
    ...
    <!-- A list of stories relating to gaming -->
    <div>
        <h2 class='body-title'>Gaming News</h2><br>
        <?php
        ...
        $stmt = $mysqli->prepare("select story_id, title, body, link, genre, DATE_FORMAT(publish_date, '%m-%d-%Y'), users.username from user_stories 
                                    left join users on user_stories.user_id = users.user_id where genre='Gaming' order by publish_date desc limit 15");
