...
<body class="body-container">
    ...
    <!-- A list of the most recently published stories regardless of genre -->
    <div class="story-container">
        ...
        $stmt = $mysqli->prepare("select story_id, title, body, link, genre, DATE_FORMAT(publish_date, '%m-%d-%Y'), users.username from user_stories 
                                    left join users on user_stories.user_id = users.user_id order by publish_date desc limit 15");
            ...
            echo "<li class='story-entry'>";
                echo "<div class='story-entry-container'>\n";
                    echo "<div class='entry-header-container'>";
                        // Clicking on title of story leads to a page displaying the full story
                        // where comments can be made and upvoted
